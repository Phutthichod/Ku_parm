    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header header-modal">
                <h4 class="modal-title" id="largeModalLabel" style="color:white">เพิ่มศัตรูพืชอื่นๆ</h4>
            </div>
            <div class="modal-body">
                ...
                <div class='row clearfix'>
                    ...
                    <div class='col-lg-8 col-md-8 col-sm-9 col-xs-6'>
                        <div class='form-group'>
                            <div class='form-line'>
                                <input type='text' id='office-name' name='tilename' class='form-control'  >
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class='row clearfix'>
                    ...
                    <div class='col-lg-8 col-md-8 col-sm-9 col-xs-6'>
                        <div class='form-group'>
                            <div class='form-line'>
                                <textarea type="text" rows="2" class="form-control mb-2"  id="style" placeholder="ลักษณะ" ></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class='row clearfix'>
                    ...
                    <div class='col-lg-8 col-md-8 col-sm-9 col-xs-6'>
                        <div class='form-group'>
                            <div class='form-line'>
                                <textarea type="text" rows="2" class="form-control mb-2"  id="style-danger" placeholder="อันตราย" ></textarea>
